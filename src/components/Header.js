...
export default function Header() {
    ...
    // </div>
    <div className='w-full h-[80px] flex justify-center items-center px-4 bg-orange-400 text-gray-300'>
        <img className="fixed-left" src={Logo} alt="Logo" style={{width: '200px'}} />
        <p className="text-white">Keep track of gift ideas for any occasion.</p>
    </div>
    )
